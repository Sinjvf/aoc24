...
import com.example.solutions.DaySolution25
import kotlinx.coroutines.test.runTest
import org.junit.Assert.assertEquals
import org.junit.Test

class DaySolution25Test {
    private val solution = DaySolution25(TestLogger())

    @Test
    fun testPart1() = runTest {
        input25.forEachIndexed { id, str -> solution.part1.handleLine(str, id) }
